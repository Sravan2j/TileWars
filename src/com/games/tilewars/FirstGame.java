...
public class FirstGame extends Activity implements FlipCompleteListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 * setContentView(R.layout.apilt11_main); } else {
		 */
	...
	public void gameOver() {
		...
		currTimeMillisVal = (Integer.parseInt(splitValues[0]) * 60000)
				+ (Integer.parseInt(splitValues[1]) * 1000)
	...
	private void loadSavedPreferences() {
		...
		if (sharedPreferences.contains("TilesFirstGame")) {
			...
			if (maxTimeValue != "") {
				...
				maxTimeMillisVal = (Integer.parseInt(splitValues[0]) * 60000)
						+ (Integer.parseInt(splitValues[1]) * 1000)
						+ Integer.parseInt(splitValues[2]);
			}
		}
